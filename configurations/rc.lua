...
local si = awful.screen.focused({ client=true}).index
print(si)
praisewidget.text = si .. " "
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "k", 
		function () 
			...
			praisewidget.text = awful.screen.focused({ client=true}).index .. " "
		end,
    ...
    awful.key({ modkey },            ";",     function () praisewidget.text = awful.screen.focused({ client=true}).index .. " " end,
              {description = "display layout", group = "launcher"}),
