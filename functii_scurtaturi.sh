...
alias pipeline='nautilus ~/Downloads/pipeline & exit'
alias pipe='pipeline'
alias igenerator='firefox /home/alex/projects/Dataglide/Publish.Config/scripts/Client\ Pipeline\ Config\ Generator/ingest_config_editor/ingest_pipeline_config.html && exit'
alias ig='igenerator'
#========== End of aliases ==========   
...
# - puts the original folder inside the Resources directory
# - cleans unused files
# 
# Obs:
# path to Downloads dir and pipeline dir are hardcoded here
function put_ingres_config() {
	download_folder="/home/alex/Downloads"
	pipeline_folder="/home/alex/Downloads/pipeline"
